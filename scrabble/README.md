...
* Recall that computers represent characters using ASCII, a standard that represents each character as a number.  As such, you can do simple arithmetic operations with characters, such as addition and subtraction, as in `'B' - 'A' = 1`.
{% endspoiler %}
