...
* Recall that computers represent characters using [ASCII](http://www.asciitable.com/), a standard that represents each character as a number.  As such, you can do simple arithmetic operations with characters, such as addition and subtraction, as in `'B' - 'A' = 1`.
